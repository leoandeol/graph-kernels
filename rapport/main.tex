...
\todo{Donner métrique utilisée et son equation}
...
\subsubsection{Graphs}
\todo{DOnner nom BD et donner des statistiques dessus}
\todo{Experiments on synthetic data...on real data}
\todo{rappeller toy data}
...
\todo{Rappeller résolution des méthodes}
...
\paragraph{Spectral Decompostion}
...
\paragraph{Accuracy comparison between labeled and unlabeled graphs}
...
\paragraph{Efficiency of alternate methods}
\begin{table}[!htb]
\begin{center}
...
\end{table}
\paragraph{Experiments on a biology dataset}
...
\paragraph{Comparison of their gram matrices}
...
\paragraph{Individual kernel analysis ?}
